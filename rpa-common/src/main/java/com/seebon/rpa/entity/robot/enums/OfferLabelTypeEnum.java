...
public enum OfferLabelTypeEnum {
    ...
    OfferLabelTypeEnum(String code, String name, Integer businessType, Integer changeType) {
        this.code = code;
        this.name = name;
        this.businessType = businessType;
        this.changeType = changeType;
    ...
    public static String getCode(String name) {
        ...
        for (OfferLabelTypeEnum item : OfferLabelTypeEnum.values()) {
            if (item.equals(OfferLabelTypeEnum.valueOf(name))) {
                return item.getCode();
            }
        }
        return null;
