...
public class DeclareOfferExportParamsDTO {
    ...
    @ApiModelProperty("申报数据子节点")
    private String operationType;

    @ApiModelProperty("申报数据子节点，多个用逗号隔开")
    private String operationTypes;

    @ApiModelProperty("申报账户")
    private String accountNumber;

    @ApiModelProperty("申报账户，多个用逗号隔开")
    ...
    @ApiModelProperty("申报类型，1：增员，2：减员，3：调基，5：补缴,多个用逗号隔开")
