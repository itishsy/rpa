 ...
 * 社保增减员流水表
 */
@ApiModel(value = "社保增减员流水表")
@Data
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "employee_social_declare_changee_process")
public class EmployeeSocialDeclareChangeeProcess implements Serializable {
    @Column
    @ApiModelProperty(value = "")
    private Integer id;

    /**
     * 人员社保增减员uuid 对应表employee_social_declare_change uuid
     */
    @Column
    @ApiModelProperty(value = "人员社保增减员uuid 对应表employee_social_declare_change uuid")
     ...
     */
    @Column
    @ApiModelProperty(value = "流水类型：0、作废，1、创建  3、导出 4、回盘 5、修改申报状态 6、运维人员已处理")
