...
Sign in
Sign up
47934ayiaq1/el-tree-select
Code Issues 1 Pull requests 0 Projects 0 Security Insights
Join GitHub today
GitHub is home to over 40 million developers working together to host and review code, manage projects, and build software together.

el-tree-select/src/components/src/ElTreeSelect.vue
huangyi 3.1.7
b52e4f3 on 30 Sep
488 lines (482 sloc)  16.8 KB-->
...
import { each } from '../../utils/treeSelect'
// @group api
export default {
  props: {
  ...
  methods: {
    ...
    _selectRemoveTag (tag) {
      ...
      // console.log("propsLabel==="+this.propsLabel)
      // console.log("propsChildren==="+this.propsChildren)
