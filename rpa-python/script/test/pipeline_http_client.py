...
parser.add_argument("--image_dir", type=str, default="D:\\seebon\\rpa\\python\\images")
...
url = "http://192.168.0.102:9998/ocr/prediction"
...
for idx, img_file in enumerate(test_img_list):
    ...
    data = {"key": ["image","probability","output_type","output_result","return_location","include_location","return_coordinates","rec","return_visual_token"],
     "value": [image,"false","true","json","false","false","false","false","false"]}
